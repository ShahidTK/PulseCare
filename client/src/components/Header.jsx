...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6FFF] rounded-lg px-6 md:px-10 lg:px-20 '>
      {/* left side */}
      <div className='md:w-1/2 flex flex-col flex-wrap items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
            ...
            <p>Get quality healthcare from experienced and certified doctors at your convenience.
              Easily schedule appointments, manage bookings, and access trusted medical care anytime.</p>
        </div>
