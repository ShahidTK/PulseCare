    ...
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <div  className='w-full grid  gap-4 pt-5 gap-y-6 px-3 sm:px-0'  style={{ gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))" }}>
        {doctors.slice(0, 10).map((item)=>(
            <div onClick={()=> navigate(`/appointment/${item._id}`)} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:-translate-y-3 transform transition duration-500'>
